...
| Plugin | Role | Status |
| --- | --- | --- |
| [`odsi-lms`](plugins/odsi-lms) | Courses, lessons, topics, quizzes, enrollment, progress, reports, certificates, cohorts, course builder | 119 tests + browser E2E passing |
