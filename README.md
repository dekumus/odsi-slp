...
| Plugin | Role | Status |
| --- | --- | --- |
| [`odsi-lms`](plugins/odsi-lms) | Courses, lessons, topics, quizzes, assignments, enrollment, progress, reports, certificates, cohorts, course builder | 129 tests + browser E2E passing |
